...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_PHASE_SYNC_ACCURACY,    PARAM_TYPE_FRACT_10,  F32I(0), F32I(10),  F32I(3),     0,  TEXT(TR_ID_UNITS_GRAD)),
    PARAM_DESCR(PARAM_ID_PHASE_SYNC_PLL_PID_K_P, PARAM_TYPE_FRACT_100, F32I(0), F32I(100), F32(18, 1),  0, NOUNITS), // Kp.
    ...
    PARAM_DESCR(PARAM_ID_PHASES_PROT_ENABLED,      PARAM_TYPE_UINT, 0,     1,   1, 0, NOUNITS),
    PARAM_DESCR(PARAM_ID_PHASES_PROT_TIME_MS,      PARAM_TYPE_UINT, 0, 60000,  40, 0, TEXT(TR_ID_UNITS_MS)),
    PARAM_DESCR(PARAM_ID_PHASES_PROT_ACTION,       PARAM_TYPE_UINT, 0,     4,   4, 0, NOUNITS),
