...
MENU_DESCRS(menu_descrs) {
    ...
    MENU_DESCR(0, 0, "Защита", NULL, 0, 0, 0, 0),
        ...
        // Напряжение сети.
        MENU_DESCR(1, 0, "Напряжение сети", NULL, 0, 0, 0, 0),
            MENU_DESCR(2, 0, "Отсечка", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, PARAM_ID_PROT_U_IN_CUTOFF_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
            MENU_DESCR(2, 0, "Повышение", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, 0, "Уровень ошибки", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_FAULT_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_FAULT_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_FAULT_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_FAULT_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_FAULT_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
                MENU_DESCR(3, 0, "Уровень предупреждения", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_WARN_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_WARN_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_WARN_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_WARN_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_OVF_WARN_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
            MENU_DESCR(2, 0, "Понижение", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, 0, "Уровень ошибки", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_FAULT_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_FAULT_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_FAULT_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_FAULT_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_FAULT_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
                MENU_DESCR(3, 0, "Уровень предупреждения", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_WARN_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_WARN_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_WARN_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_WARN_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_IN_UDF_WARN_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
        // Ток сети.
        MENU_DESCR(1, 0, "Ток сети", NULL, 0, 0, 0, 0),
            MENU_DESCR(2, 0, "Отсечка", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, PARAM_ID_PROT_I_IN_CUTOFF_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
            MENU_DESCR(2, 0, "Повышение", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, 0, "Уровень ошибки", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_FAULT_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_FAULT_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_FAULT_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_FAULT_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_FAULT_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
                MENU_DESCR(3, 0, "Уровень предупреждения", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_WARN_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_WARN_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_WARN_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_WARN_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_IN_OVF_WARN_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
        // Напряжение якоря.
        MENU_DESCR(1, 0, "Напряжение якоря", NULL, 0, 0, 0, 0),
            MENU_DESCR(2, 0, "Отсечка", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, PARAM_ID_PROT_U_ROT_CUTOFF_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
            MENU_DESCR(2, 0, "Повышение", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, 0, "Уровень ошибки", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_FAULT_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_FAULT_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_FAULT_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_FAULT_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_FAULT_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
                MENU_DESCR(3, 0, "Уровень предупреждения", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_WARN_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_WARN_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_WARN_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_WARN_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_U_ROT_OVF_WARN_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
        // Ток якоря.
        MENU_DESCR(1, 0, "Ток якоря", NULL, 0, 0, 0, 0),
            MENU_DESCR(2, 0, "Отсечка", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, PARAM_ID_PROT_I_ROT_CUTOFF_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
            MENU_DESCR(2, 0, "Повышение", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, 0, "Уровень ошибки", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_FAULT_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_FAULT_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_FAULT_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_FAULT_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_FAULT_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
                MENU_DESCR(3, 0, "Уровень предупреждения", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_WARN_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_WARN_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_WARN_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_WARN_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_ROT_OVF_WARN_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
        // Ток возбуждения.
        MENU_DESCR(1, 0, "Ток возбуждения", NULL, 0, 0, 0, 0),
            MENU_DESCR(2, 0, "Отсечка", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, PARAM_ID_PROT_I_EXC_CUTOFF_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
            MENU_DESCR(2, 0, "Повышение", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, 0, "Уровень ошибки", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_FAULT_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_FAULT_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_FAULT_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_FAULT_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_FAULT_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
                MENU_DESCR(3, 0, "Уровень предупреждения", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_WARN_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_WARN_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_WARN_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_WARN_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_OVF_WARN_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
            MENU_DESCR(2, 0, "Понижение", NULL, 0, 0, 0, 0),
                MENU_DESCR(3, 0, "Уровень ошибки", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_FAULT_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_FAULT_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_FAULT_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_FAULT_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_FAULT_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
                MENU_DESCR(3, 0, "Уровень предупреждения", NULL, 0, 0, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_WARN_ENABLE, "Включено", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_WARN_LEVEL_VALUE, "Отклонение", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_WARN_LEVEL_TIME_MS, "Время отклонения", NULL, 0, MENU_FLAG_DATA, 0, 0),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_WARN_LATCH_ENABLE, "Защёлка", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_bool),
                    MENU_DESCR(4, PARAM_ID_PROT_I_EXC_UDF_WARN_ACTION, "Действие", NULL, 0, MENU_FLAG_DATA, 0, &menu_val_prot_action),
        // Дрейф нуля.
