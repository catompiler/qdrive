...
MENU_VALUES(menu_enum_gui_tiles,
    ...
    MAKE_MENU_VALUE_STRING(TEXT(TR_ID_ENUM_HEATSINK_TEMP)),             // PARAM_ID_HEATSINK_TEMP  
    MAKE_MENU_VALUE_STRING(TEXT(TR_ID_ENUM_HEATSINK_FAN_RPM)),          // PARAM_ID_HEATSINK_FAN_RPM 
